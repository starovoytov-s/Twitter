...
//  Twitter
//
//  Created by Stanislav Starovoytov on 22.10.2020.
//
...
class ActionSheetLauncher: NSObject {
    ...
    func showTableView(_ shouldShow: Bool) {
        ...
        guard let hegiht = tableViewHeight else { return }
        let y = shouldShow ? window.frame.height - hegiht : window.frame.height
